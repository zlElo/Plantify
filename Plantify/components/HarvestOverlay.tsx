...
const HarvestOverlay: React.FC<OverlayProps> = ({ isVisible, setIsVisible }) => {
  ...
  const saveData = async () => {
    try {
      ...
      // Get existing plants
      const existingPlantsJson = await AsyncStorage.getItem('@harvestData');
      ...
      await AsyncStorage.setItem('@harvestData', JSON.stringify(existingPlants));
